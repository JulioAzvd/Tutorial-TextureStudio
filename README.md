...
> `/deletemap` | - | Utilizando este comando você irá deletar o mapa atual. Apesar de aparecer uma janela para você confirmar a ação, tome cuidado para não causar nenhum acidente!<br><br> <ul><li>Aqui também se aplica o aviso deixado em `/loadmap`!
